...
{
    // константи залежать від розміщення у файлі DevelerTiles
    // При зміні спрайтів у файлі треба бути змінити константи
    ...
    void OnCollisionStay(Collision cool)
    {
        ...
        Tile ti = cool.gameObject.GetComponent<Tile>();
        if(ti == null)return;
